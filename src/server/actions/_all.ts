...
export async function seedLcaCourse() {
  ...
  const [course] = await db.insert(courses).values({
    ...
    description: "A comprehensive course on Guyana\'s Local Content Act 2021 — the legal framework, employment requirements, supplier certification, worker protections, and the petroleum sector ecosystem. Designed for compliance professionals, business owners, and workers.",
    audience: "all",
    jurisdictionCode: "GY",
    moduleCount: 5,
  ...
  const moduleData = [
    ...
    },
    {
      ...
      quiz: [
        ...
        { question: "Who can be personally liable for false LCA reports?", options: ["Only the company", "Only the CEO", "Individuals who sign or certify reports", "No one — only fines apply"], correctIndex: 2 },
