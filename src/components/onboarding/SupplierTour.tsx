  ...
  },
  {
    ...
    extra: (
      <div className="mt-4 rounded-lg bg-success/5 border border-success/20 p-3">
        ...
        <p className="text-sm text-text-secondary">Every dollar contractors spend with LCS-verified suppliers counts toward their compliance score. Your certificate is your competitive advantage.</p>
      </div>
    ),
  },
  {
    ...
    extra: (
      <div className="mt-4 grid grid-cols-3 gap-2 text-center">
        <div className="rounded-lg bg-bg-primary p-2"><p className="text-lg font-bold text-accent">190+</p><p className="text-xs text-text-muted">Notices</p></div>
        <div className="rounded-lg bg-bg-primary p-2"><p className="text-lg font-bold text-success">3/mo</p><p className="text-xs text-text-muted">Free Responses</p></div>
        <div className="rounded-lg bg-bg-primary p-2"><p className="text-lg font-bold text-gold">$99</p><p className="text-xs text-text-muted">Pro Unlimited</p></div>
      </div>
    ),
  },
  {
      ...
      <div className="mt-4 grid grid-cols-4 gap-1 text-center">
        {["Interested", "Contacted", "Shortlisted", "Awarded"].map((s, i) => (
          <div key={s}>
            ...
            <p className="text-[11px] text-text-muted mt-0.5">{s}</p>
          </div>
        ))}
      </div>
    ),
