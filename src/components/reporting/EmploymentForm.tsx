...
export function EmploymentForm({ defaultValues, onSubmit, onCancel, loading }: EmploymentFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <p className="text-sm text-text-muted -mt-2">Total compensation including base salary, bonuses, overtime, and other financial benefits for the reporting period.</p>
